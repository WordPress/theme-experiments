...
if ( function_exists( 'register_block_pattern' ) ) {
	...
	register_block_pattern(
		...
		array(
			...
			<!-- wp:post-hierarchical-terms {"term":"category","fontSize":"extra-small"} /-->

			<!-- wp:post-tags {"fontSize":"extra-small"} /-->
			...
			<!-- wp:buttons -->
			<div class="wp-block-buttons"><!-- wp:button {"borderRadius":0,"backgroundColor":"dark-blue","className":"has-custom-font-size has-extra-small-font-size"} -->
			<div class="wp-block-button has-custom-font-size has-extra-small-font-size"><a class="wp-block-button__link has-dark-blue-background-color has-background no-border-radius">' . esc_html_x( 'Contact', 'sample content', 'armando' ) . '</a></div>
			<!-- /wp:button --></div>
			<!-- /wp:buttons -->
	...
	register_block_pattern(
		...
		array(
			...
			<p class="has-large-font-size"><strong>' . esc_html_x( 'Sample content. Replace the placeholder coverblock with your own image.', 'sample content', 'armando' ) . '</strong></p>
			<!-- /wp:paragraph -->
			...
			<!-- wp:post-hierarchical-terms {"term":"category","fontSize":"extra-small"} /--></div>
			<!-- /wp:group --></div>
			<!-- /wp:group --></div></div>
			<!-- /wp:cover -->
			',
